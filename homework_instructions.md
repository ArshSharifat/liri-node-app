...
1. `node liri.js concert-this <artist/band name here>`
   ...
   * This will search the Bands in Town Artist Events API (`"https://rst.bandsintown.com/artists/" + artist + "/events?app_id=codingbootcamp"`) for an artist and render the following information about each event to the terminal:
